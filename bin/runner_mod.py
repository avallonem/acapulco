...
def run():
    ...
    d1={}
    d1["chan"]="cowrie"
    d1["time"]="Mon Jul 2 22:59:46 2018"
    d1["saddr"]="10.234.123.34"
    d1["sport"]="45432"
    d1["daddr"]="10.243.43.23"
    d1["dport"]="22"
    d1["url"]="www.google.it"
    d1["hash"]="assdaasdgasdgasdg987987a"
    events.append(d1)
    d1={}
    d1["chan"]="cowrie"
    d1["time"]="Mon Jul 2 22:59:46 2018"
    d1["saddr"]="10.234.128.34"
    d1["sport"]="452"
    d1["daddr"]="10.243.44.23"
    d1["dport"]="23"
    d1["url"]="www.google.it"
    d1["hash"]="assdaasdgasdgasdg987987a"
    events.append(d1)
    ...
    save(events_normal,"/root/acapulco/Acapulco4HNP/bin/log","csv","acapulco_normal")
    ...
    save(events_cls,"/root/acapulco/Acapulco4HNP/bin/log","csv","acapulco_clustered")
