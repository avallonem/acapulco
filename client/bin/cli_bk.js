...
(function() {
    ...
    var createServer = function(port) {
        ...
        var server = http.createServer(function(request, response) {
            ...
            var search_size=url_es.search;
            var num_size=search_size.substring(search_size.indexOf("=")+1);
           ...
           //MOD     
            ...
            host: [{
                host: 'index.eval.sissden.eu',
                auth: 'AKIDPOSTE:PhieVe8va2Ooloth6aepoung9uraiquah7ohgaeD',
                protocol: 'https',
                port: 443
            }]
            });
            ...
            const body=client.search({
                ...
                }, function getMoreUntilDone(error, response2) {
            // collect the title from each response
                    var data="[";
                    response2.hits.hits.forEach(function(hit) {
                    var partial="{\""+"src_ip\" : \""+ip2int(hit._source.src_ip)+"\",\""+"src_port\" : \""+ hit._source.src_port+"\",\""+"dest_ip\" : \""+ip2int(hit._source.dest_ip)+"\",\""+"dest_port\" : \""+hit._source.dest_port+"\",\"url\" : \"234235235\"},"
                    data+=partial;
